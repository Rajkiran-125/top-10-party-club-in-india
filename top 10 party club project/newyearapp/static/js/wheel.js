function shuffle(array) {
  ...
  function spin() {
    ...
    if (MagicRoaster.includes(Hasil[0])) SelectedItem = "25% Discount";
    if (Sepeda.includes(Hasil[0])) SelectedItem = "Nothing";
    if (RiceCooker.includes(Hasil[0])) SelectedItem = "75% Discount";
    if (LunchBox.includes(Hasil[0])) SelectedItem = "Buy 1 get 1 free Ticket";
    if (Sanken.includes(Hasil[0])) SelectedItem = "Better luck next time!!";
    if (Electrolux.includes(Hasil[0])) SelectedItem = "Gift Voucher";
    if (JblSpeaker.includes(Hasil[0])) SelectedItem = "10% Discount";
